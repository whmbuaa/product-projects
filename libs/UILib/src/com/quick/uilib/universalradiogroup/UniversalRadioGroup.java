 ...
 *
 */
public class UniversalRadioGroup extends LinearLayout {
  

	// holds the checked id; the selection is empty by default
    private int mCheckedId = -1;
    // tracks children radio buttons checked state
    private CompoundViewGroup.OnCheckedChangeListener mChildOnCheckedChangeListener;
    ...
    public UniversalRadioGroup(Context context, AttributeSet attrs, int defStyle) {
     ...
     * {@inheritDoc}
     */
    public UniversalRadioGroup(Context context) {
        super(context);
     ...
     * {@inheritDoc}
     */
    public UniversalRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                attrs, com.android.internal.R.styleable.AnyRadioGroup, com.android.internal.R.attr.radioButtonStyle, 0);
//
...
//        attributes.recycle();
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new UniversalRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof UniversalRadioGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(UniversalRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(UniversalRadioGroup.class.getName());
    }
    ...
    private class CheckedStateTracker implements CompoundViewGroup.OnCheckedChangeListener {
        public void onCheckedChanged(CompoundViewGroup buttonView, boolean isChecked) {
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == UniversalRadioGroup.this && child instanceof CompoundViewGroup) {
                int id = child.getId();
                // generates an id if it's missing
                
                
                if (id == View.NO_ID) {
                	//whm: change according to api:2.1
                    id = child.hashCode();
                    child.setId(id);
                }
