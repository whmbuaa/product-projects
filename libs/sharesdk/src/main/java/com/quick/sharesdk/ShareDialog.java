...
public class ShareDialog {
    ...
    private int[] image = {R.drawable.share_sina, R.drawable.share_wechat, R.drawable.share_wechat_moments, R.drawable.share_qq};
